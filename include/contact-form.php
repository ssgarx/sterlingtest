...
$to = "abhishek@thesterling.co, ankita@thesterling.co";
//$to = "shobhitagarwal2012@gmail.com";
...
$subject = isset($_POST["widget-contact-form-subject"]) ? $_POST["widget-contact-form-subject"] : 'New Lead Sterling AG';
...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
 ...
 if($email != '') {
                ...
                //$mail->Username = 'puneet@sterlingtech.xyz';                    // SMTP username
                //$mail->Password = '!2bF0fI@oazj';                    // SMTP password
                ...
                $mail->From = 'noreply@thesterling.co';
                $mail->FromName = 'Sterling AG';
                ...
                $name = isset($name) ? "Organization/ Name: $name<br><br>" : '';
                $email = isset($email) ? "Email: $email<br><br>" : '';
                $phone = isset($phone) ? "Phone: $phone<br><br>" : '';
                $company = isset($company) ? "Company: $company<br><br>" : '';
                $service = isset($service) ? "Service: $service<br><br>" : '';
                $message = isset($message) ? "Message/ Brief: $message<br><br>" : '';
                

                $mail->Body = 'Hi Abhishek, <br><br>' . $name . $email . $phone . $company . $service . $message . '<br>This email was sent from: ' . $_SERVER['HTTP_REFERER'] . '<br><br> Regards, <br>Sterling AG';
